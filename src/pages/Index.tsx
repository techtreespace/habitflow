  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-1/2 translate-x-1/2 w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center"
